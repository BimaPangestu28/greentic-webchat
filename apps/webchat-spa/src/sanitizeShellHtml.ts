...
const ALLOWED_TAGS = ['div', 'span', 'p', 'a', 'ul', 'ol', 'li', 'strong', 'em', 'br', 'h1', 'h2', 'h3', 'header', 'footer', 'section', 'nav', 'img', 'code'];
const ALLOWED_ATTR = ['href', 'title', 'target', 'class', 'id', 'src', 'alt', 'aria-label', 'aria-live', 'aria-hidden', 'rel'];
